...
const BADGES = [
  {
    icon: Shield,
    label: "Institutional Security Grade",
    color: "#22c55e",
    dot: "#22c55e",
  ...
  {
    icon: Zap,
    label: "Luxury Brand Partner: Shamim Forever",
    color: "#D4AF37",
    dot: "#22c55e",
    href: "https://www.shamimforever.com",
  },
  {
    icon: Building2,
    label: "Backed by Orakzai Properties",
    color: "#D4AF37",
    dot: "#D4AF37",
    href: "/about",
  },
  {
    icon: FileCheck,
    label: "Verified Polygon Smart Contracts",
    color: "#60A5FA",
    dot: "#22c55e",
