...
const CARDS = [
  ...
  {
    icon: RotateCcw,
    title: "Smart Contract Refund",
    desc: "Didn't win? No problem. If you're not selected as a winner, all of your entry tokens are automatically returned to your wallet by the smart contract — instantly, with zero deductions.",
