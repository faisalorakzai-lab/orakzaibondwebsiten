...
const DOCS = [
  {
    ...
    dlHref: "https://drive.google.com/uc?export=download&id=1Psz7Iy5aREH_ltKPGLglTwR2ln1VTHWS",
    viewHref: "https://drive.google.com/file/d/1Psz7Iy5aREH_ltKPGLglTwR2ln1VTHWS/view?usp=drivesdk",
  },
  {
    id: "pitchdeck",
    ...
    subtitle: "Investor Introduction · Official PDF",
    description:
      "Official investor-facing marketing overview and introduction to the Orakzai Bond ecosystem — product suite, use cases, and the OKBOND investment opportunity.",
    size: "PDF",
    pages: "Official Document",
    accent: "#a78bfa",
    accentRgb: "167,139,250",
    border: "rgba(167,139,250,0.28)",
    glow: "rgba(167,139,250,0.10)",
    iconBg: "rgba(167,139,250,0.12)",
    dlHref: "https://drive.google.com/uc?export=download&id=1Q6bClDOeBCBxBZfKdD9SnqSpNFrG-u7A",
    viewHref: "https://drive.google.com/file/d/1Q6bClDOeBCBxBZfKdD9SnqSpNFrG-u7A/view?usp=drivesdk",
  },
  {
    id: "audit",
    ...
    subtitle: "Polygon Mainnet · Independent Review",
    description:
      "Independent security review of all OKBOND smart contracts deployed on Polygon Mainnet — vulnerability assessment, reentrancy protection, ownership controls, and access control analysis.",
    size: "PDF",
    pages: "Security Review",
    accent: "#22c55e",
    accentRgb: "34,197,94",
    border: "rgba(34,197,94,0.28)",
    glow: "rgba(34,197,94,0.10)",
    iconBg: "rgba(34,197,94,0.12)",
    dlHref: "https://drive.google.com/uc?export=download&id=1T_isI9xvQQr_Mbkt1YyBvNF4kLUOcVgj",
    viewHref: "https://drive.google.com/file/d/1T_isI9xvQQr_Mbkt1YyBvNF4kLUOcVgj/view?usp=drivesdk",
  },
  {
    id: "legal",
