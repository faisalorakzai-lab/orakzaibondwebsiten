...
const FALLBACK_GREETING_INVESTOR =
  "Marcus online. I serve as Digital Chief of Staff for the Orakzai Group, founded and led by Chairman Faisal Orakzai — who began building at age twelve and now, at nineteen, commands twelve mother companies. Our flagship instrument is Orakzai Bond, known as OKBOND, a live token on Polygon Mainnet backed by a Trust Trifecta of sovereign land assets: Azan Smart City in Lahore, Azan Smart City in Islamabad, and ancestral Orakzai tribal territories in Khyber Pakhtunkhwa. The ICO Phase One price is fifteen US cents per token, rising to twenty-five cents in Phase Two. The smart contract has been independently audited, our SECP registration is underway, and our lottery system rewards all holders proportionally. I can answer every question about OKBOND, the investment mechanics, the Chairman's vision, or anything else about the Group. What would you like to know?";

const FALLBACK_GREETING_CHAIRMAN =
  "Chairman Orakzai. Marcus reporting. The Orakzai Bond Grid is fully operational, the Group is on trajectory across all twelve mother companies, and your Vision twenty-one-hundred mandate is being executed on every front. OKBOND ICO Phase One is live at fifteen cents per token, the Trust Trifecta assets are verified and secure, and the concierge is standing by for any institutional intake. The smart contract audit is public, SECP registration is in progress, and community momentum is building. I am ready to execute any instruction or deliver a full situational briefing on any aspect of the Group. Standing by, Chairman.";

const INVESTOR_FALLBACK =
  "Orakzai Bond is not a speculative token — it is the institutional financial backbone of the Orakzai Group on Polygon Mainnet. Every OKBOND token is anchored by the Trust Trifecta: sovereign land in Lahore, Islamabad, and Khyber Pakhtunkhwa; complete on-chain transparency with public verification at every level; and an active path to SECP certification in Pakistan. The ICO Phase One is priced at fifteen US cents — Phase Two rises to twenty-five cents, representing a sixty-seven percent step-up. Holders participate in a lottery system where more tokens mean more entries. For private onboarding and institutional-scale investment, our WhatsApp concierge operates around the clock with direct access to the Chairman's team. The full whitepaper, audit report, and tokenomics are on this website for your review.";
